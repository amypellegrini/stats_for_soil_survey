...
To start, as always, you need to load some extra R packages. This becomes a familar routine every time you start R. Most of the basic functions you need to develop a linear regression model are contained in base R, but the following packages contain some useful spatial and data manipulation functions. Believe it or not, you will use all of them and more.
