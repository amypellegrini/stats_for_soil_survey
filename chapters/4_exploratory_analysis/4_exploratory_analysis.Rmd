...
5.	Enter or replace the soil series of interest, and click the **Knit HTML** button. Be sure to encase the name of the soil series in quotations, using either double or single quotation marks, e.g., `"series"` or `'series'`.
