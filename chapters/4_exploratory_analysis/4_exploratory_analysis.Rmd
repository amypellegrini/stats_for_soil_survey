...
abline(v = quantile(r, p = 0.5), lty = 2)
```
Figure 1.— *Editor's note: Please add a caption. Because this chapter uses some captions, all of the figures should have a caption. Note also that many of the figures do not appear in the RMD file. I don't know if the lack of imagery in the RMD file matters other than making it difficult to predict what the HTML file will look like.*
