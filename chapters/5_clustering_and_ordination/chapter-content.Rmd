...
##5.11 Similarity, Disimilarty, and Distance
...
##5.12 Standardization of Characteristics
...
##5.13 Quick Detour: Missing Data
...
##5.14 Visualizing Pair-Wise Distances: The Dendrogram
...
##5.15 Cluster Analysis: Finding Groups in Data
...
###5.151 Using Color to Communicate the Results of a Clustering or Ordination Exercise
...
###5.153 Centroid and Medoid (Partitioning) Clustering
...
##5.16 Ordination: Visualization in a Reduced Space
...
###5.161 An example of nMDS applied to soil data
...
##5.18 Pair-Wise Distances Between Soil Profiles?  
...
##5.23 More on the Distance Matrix and How To Make One
...
###5.231 Distance Calculations with Categorical Data
...
###5.241 Basic Agglomerative Hierarchical Clustering with `hclust`
...
###5.242 Better Plots via `ape` Package
...
###5.243 Comparison of Dendrograms
...
##5.25 Centroid and Medoid (Partitioning) Clustering
...
##5.26 Ordination (Non-Metric Multidimensional Scaling)

###5.261 Sammon's Non-Linear Mapping
...
###5.262 nMDS with the `vegan` Package

###5.263 Interpretation and Goodness of Fit
...
##5.31 Pair-Wise Distances Between Soil Profiles 
...
##5.32 Pair-Wise Distances Between Subgroup-Level Taxa
...
##5.34 How Do the Interpretations Compare?
